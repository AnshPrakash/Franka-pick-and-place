...
Edit l_panda_joint1 : {limits : [-2.9671, 2.9671, 2.175, -1.0, 87.0]}
Edit l_panda_joint2 : {q: -.5, limits : [-1.8326, 1.8326, 2.175, -1.0, 87.0]}
Edit l_panda_joint3 : {limits : [-2.9671, 2.9671, 2.175, -1.0, 87.0]}
Edit l_panda_joint4 : {q: -2 , limits : [-3.1416, 0.0, 2.175, -1.0, 87.0]}
Edit l_panda_joint5 : {limits : [-2.9671, 2.9671, 2.61, -1.0, 12.0]}
Edit l_panda_joint6 : {limits : [0.0873, 3.8223]}
Edit l_panda_joint7 : {q: -.5, limits : [-2.9671, 2.9671, 2.61, -1.0, 12.0]}
